...
<!-- Pixel de facebook para instagram-->
...
<div class="container-fuild">
  <div class="container">
    <div class="products-area"> 
      <!-- heading -->
      <div class="heading">
        <h2>Novedades<small class="pull-right"><!--<a href="shop" >@lang('website.View All')</a>--></small></h2>
        <hr>
      </div>
        <div class="row"> 
            <div class="col-xs-12 col-sm-12">
                <div class="row">
                    <!-- Items -->
                    <iframe  style = "border: none;" src ="http://ecommercev2.sppflash.com.ar/instagram/feed.php" width ="100%" height ="510px"> </iframe >
