            ...
            <div class="row">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/checkout_shipping_address')}}" method="post">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="firstname" name="firstname" value="">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="lastname" name="lastname" value="">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="company" name="company" value="">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="street" name="street" value="">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="city" name="city" value="">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="delivery_phone" name="delivery_phone" value="">
                      ...
                      <div class="tab-pane fade @if(session('step') == 1) show active @endif" id="pills-billing" role="tabpanel" aria-labelledby="billing-tab">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.First Name')</label>
                            <input type="text" class="form-control same_address" id="billing_firstname" name="billing_firstname" value="">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your first name')</span>  
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Last Name')</label>
                            <input type="text" class="form-control same_address"  id="billing_lastname" name="billing_lastname" value="">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your last name')</span> 
                          </div>
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.Company')</label>
                            <input type="text" class="form-control same_address" id="billing_company" name="billing_company" value="">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your company name')</span> 
                          </div>
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.Address')</label>
                            <input type="text" class="form-control same_address"  id="billing_street" name="billing_street" value="">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your address')</span>
                          </div>
                          ...
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Country')</label>
                              <select class="form-control same_address_select" id="billing_countries_id"  onChange="getBillingZones();" name="billing_countries_id" >
                                  <option value="" selected>Seleccionar País</option>
                                  @if(count($result['countries'])>0)
                                    @foreach($result['countries'] as $countries)
                                        <option value="{{$countries->countries_id}}">{{$countries->countries_name}}</option>
                          ...
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.City')</label>
                            <input type="text" class="form-control same_address"  id="billing_city" name="billing_city" value="">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your city')</span>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Zip/Postal Code')</label>
                            <input type="text" class="form-control same_address"  id="billing_zip" name="billing_zip" value="">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your Zip/Postal Code')</span> 
                          </div>	
                          	
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Phone Number')</label>
                            <input type="text" class="form-control same_address"  id="billing_phone" name="billing_phone" value="">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your valid phone number')</span> 
                          </div>
                ...
                <div class="tab-pane fade @if(session('step') == 2) show active @endif" id="pills-shipping-methods" role="tabpanel" aria-labelledby="shipping-methods-tab">
                    <div class="shipping-methods">
                        <p class="title">Método exclusivo de envío</p>
                    <form name="shipping_mehtods" method="post" id="shipping_mehtods_form" enctype="multipart/form-data" action="{{ URL::to('/checkout_payment_method')}}">
                        ...
                        <a title="Correo Flash" href="http://correoflash.com/"><img src="http://ecommercev2.sppflash.com.ar/resources/assets/images/banner_images/logoazullogin.png" alt="Los Tejos" width="100%" aling="center" /></a>
                                        ...
                                        <ul class="list">                              
                                            @foreach($shipping_methods['services'] as $services)
                                             <?php
                                                ...
                                                ?>
                                                <li>
                                                <input class="shipping_data" id="{{$method_name}}" type="radio" name="shipping_method" value="{{$services['shipping_method']}}" shipping_price="{{$services['rate']}}"  method_name="{{$method_name}}" @if(!empty(session('shipping_detail'))) 
                    	...
                    	<div class="row">
                        	<div class="col-xs-12 col-sm-6 order-notes">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="comments" id="order_comments" class="form-control" placeholder="Order Notes">{{session('order_comments')}}</textarea>
                                </div>
                            </div>
